...
const HomeLogin = () => {
  ...
  const handleSignOut = () => {
    sessionStorage.removeItem('jwtToken'); // Remove the token
  ...
  return (
    <div className="common">
      ...
      <main className="main-content">
        ...
        <Footer />
        {/* sign out button */} 
         <button onClick={handleSignOut} style={{ margin: '20px', padding: '10px 20px', backgroundColor: '#0A2F6E', color: '#fff', border: 'none', borderRadius: '5px', cursor: 'pointer' }}>
          Sign Out
        </button> 
      </main>
...
export default withAuth(HomeLogin);
